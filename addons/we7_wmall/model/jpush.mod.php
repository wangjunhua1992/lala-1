...
function Jpush_platefrom_send($extras = array()) {
	...
	$sound_router = array(
		'takeout' => array(
			'ordernew' => 'orderNew.wav',
			'orderrefund' => 'orderRefund.wav',
		),
		'errander' => array(
			'ordernew' => 'erranderOrderNew.wav',
			'orderrefund' => 'erranderOrderRefund.wav',
		),
	);
	...
	$extras['resource'] = "{$_W['siteroot']}/addons/we7_wmall/resource/mp3/{$sound}";
	...
	$jpush = array(
		...
		'audience' => $audience,
		'message' => array(
			'msg_content' => $extras['voice_text'] ? $extras['voice_text'] : $extras['title'],
			'title' => $extras['title'],
			'extras' => $extras
		),
	);
	...
	$cloud_extra = array(
		//'Authorization' => "Basic " . base64_encode("0c6d4c4fa27202b3a3cde173:27c13954167b692bc6f8a3be"),
		'Authorization' => "Basic " . base64_encode("a138fb827d9070501e526526:a570d51f1c17cd5ed0f19009"),
	);
	...
	$jpush_ios = array(
		...
		'audience' => $audience,
		'notification' => array(
			'alert' => $extras['voice_text'] ? $extras['voice_text'] : $extras['title'],
			'ios' => array(
				'alert' => $extras['voice_text'] ? $extras['voice_text'] : $extras['title'],
				'sound' => $sound,
				'badge' => '+1',
