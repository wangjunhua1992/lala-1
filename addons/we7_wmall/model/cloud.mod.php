...
function cloud_w_query_auth($code, $module) 
{
	...
	$content = cloud_w_request("https://www.yunziyuan.com.cn", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_get_wxapp_authorize_url($wxapp_type = "we7_wmall", $uniacid = 0) 
{
	...
	$content = cloud_w_request("https://www.yunziyuan.com.cnweixin/xcx/authurl.html", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_get_wxapp_authorize_info($wxapp_type = "we7_wmall", $uniacid = 0) 
{
	...
	$content = cloud_w_request("https://www.yunziyuan.com.cnweixin/xcx/auth.html", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_wxapp_bind_tester($wechatid, $wxapp_type = "we7_wmall", $uniacid = 0) 
{
	...
	$content = cloud_w_request("https://www.yunziyuan.com.cnweixin/xcx/bind_tester.html", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_wxapp_unbind_tester($wechatid, $wxapp_type = "we7_wmall", $uniacid = 0) 
{
	...
	$params["wechatid"] = $wechatid;
	$content = cloud_w_request("https://www.yunziyuan.com.cnweixin/xcx/unbind_tester.html", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_wxapp_commit($wxapp_type = "we7_wmall", $uniacid = 0) 
{
	...
	$content = cloud_w_request("https://www.yunziyuan.com.cnweixin/xcx/commit.html", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_wxapp_submit_audit($wxapp_type = "we7_wmall", $uniacid = 0) 
{
	...
	$content = cloud_w_request("https://www.yunziyuan.com.cnweixin/xcx/submit.html", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_wxapp_get_category($wxapp_type = "we7_wmall", $uniacid = 0) 
{
	...
	$content = cloud_w_request("https://www.yunziyuan.com.cnweixin/xcx/get_category.html", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_wxapp_get_url($wxapp_type = "we7_wmall", $uniacid = 0) 
{
	...
	$content = cloud_w_request("https://www.yunziyuan.com.cnweixin/xcx/authget_url.html", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_wxapp_undocodeaudit($wxapp_type = "we7_wmall", $uniacid = 0) 
{
	...
	$content = cloud_w_request("https://www.yunziyuan.com.cnweixin/xcx/undocodeaudit.html", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_wxapp_release($wxapp_type = "we7_wmall", $uniacid = 0) 
{
	...
	$content = cloud_w_request("https://www.yunziyuan.com.cnweixin/xcx/audit.html", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_wxapp_getanywxacode($path = "", $scene = "", $wxapp_type = "we7_wmall") 
{
	...
	$params["path"] = $path;
	$params["scene"] = $scene;
	$content = cloud_w_request("https://www.yunziyuan.com.cnweixin/xcx/getanywxacode.html", $params);
	if( is_error($content) ) 
	{
		return $content;
	}
...
function cloud_w_build_base() 
{
	...
	$pars["method"] = "upgrade";
	$dat = cloud_w_request("https://www.yunziyuan.com.cn", $pars);
...
function cloud_w_download($path) 
{
	...
	$dat = cloud_w_request("https://www.yunziyuan.com.cn", $pars, $headers, 300);
	if( is_error($dat) ) 
	{
...
function cloud_w_lala_update_url($trade) 
{
	...
	$url = "https://www.yunziyuan.com.cn" . $code;
	return $url;
}
...
function cloud_w_wxapp_get_liveall($wxapp_type = "we7_wmall", $uniacid = 0) 
{
	$params = cloud_w_build_wxapp_authorize_params($wxapp_type, $uniacid);
	if( is_error($params) ) 
	{
...
function cloud_w_wxapp_get_liveinfo($roomid, $wxapp_type = "we7_wmall", $uniacid = 0) 
{
	$params = cloud_w_build_wxapp_authorize_params($wxapp_type, $uniacid);
	if( is_error($params) ) 
	{
	...
	$content = cloud_w_request("https://www.yunziyuan.com.cn" . $roomid, $params);
	if( is_error($content) ) 
	{
		return $content;
	}
