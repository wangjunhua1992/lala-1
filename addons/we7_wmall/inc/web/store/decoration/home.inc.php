		...
		$params = array (
			...
			'items' => array (
				'M1528801076072' => array (
					...
					'params' => array (
							'picturedata' => 0,
							'has_gohome' => check_plugin_exist('gohome') ? 1 : 0
						),
					'data' => array (
				...
				'M1528801043513' => array (
					'params' => array(
						...
						'showtype' => 0,
						'showdot' => 0,
						'has_diypage' => check_plugin_perm('diypage') ? 1 : 0
					),
					'style' => array (
						'margintop' => '0',
						'style' => '2',
					...
					'data' => array (
						...
						'C1528801043516' => array (
							...
							'linkurl' => "tangshi/pages/reserve/index?sid={$store_id}",
							'text' => '预定',
							'color' => '#333333',
							'decoration' => '点餐预定',
							'dec_color' => '#a0a0a0',
						),
						'C1528801043517' => array (
							'imgurl' => '../addons/we7_wmall/plugin/wxapp/static/img/default/navs-1.png',
							'linkurl' => "tangshi/pages/assign/assign?sid={$store_id}",
							'text' => '排号',
							'color' => '#333333',
							'decoration' => '店内排号',
							'dec_color' => '#a0a0a0',
