...
if($ta == 'index') {
	...
	if(is_ios() && (is_h5app() || is_glala()) && !empty($config_app_customer) && empty($config_app_customer['iosstatus'])) {
		if(!empty($config_app_customer['iosurl'])) {
			$result = array(
				'url' => $config_app_customer['iosurl']
			);
