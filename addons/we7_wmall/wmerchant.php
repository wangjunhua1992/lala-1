...
require IA_ROOT . '/addons/we7_wmall/loader.php';
load()->func('global');
load()->func('compat');
load()->func('pdo');
load()->classs('account');
...
if(empty($_W['uniacid'])) {
	...
	if(empty($_GPC['ii_store'])) {
		isetcookie('ii_store', $_W['uniacid']);
	}
}
...
if($_GPC['c'] == 'utility' && $_GPC['a'] == 'file') {
	require IA_ROOT . '/web/source/utility/ifile.ctrl.php';
	return;
}
