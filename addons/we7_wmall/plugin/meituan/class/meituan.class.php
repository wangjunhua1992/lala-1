...
class Meituan{
	...
	public function __construct($sid = 0) {
		...
		$this->app = array(
			'sid' => $sid,
			'store' => array(
				'meituan_status' => $store['meituan_status'],
				'meituan' => $store['data']['meituan'],
				'shopid' => $store['meituanShopId'],
			),
		...
		$api_urls = array(
			'sandbox' => 'http://api.open.cater.meituan.com/waimai/',
			'open' => 'http://api.open.cater.meituan.com/waimai/',
		);
