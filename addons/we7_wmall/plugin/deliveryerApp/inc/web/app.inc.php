...
$downurls = array(
	'deliveryer' => array(
		...
		'apk' => MODULE_ROOT . "/resource/apps/{$_W['uniacid']}/android/deliveryman_1.0.apk",
	)
);
if($op == 'app') {
	...
	if($_W['ispost']) {
		if($_GPC['form_type'] == 'setting_app') {
			...
			$data = array(
				...
				'push_tags' => $_config['deliveryer']['push_tags'],
				...
				'xunfei_Android_appid' => trim($_GPC['deliveryer']['xunfei_Android_appid']),
				'xunfei_ios_appid' => trim($_GPC['deliveryer']['xunfei_ios_appid']),
