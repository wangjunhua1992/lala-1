...
if($op == 'index') {
	...
	$result = array(
		...
		'month' => $month,
		'calendar' => $calendar,
		'continuous_get' => $continuous_get,
		'all_get' => $all_get,
		'order_days_amount' => $order_days_amount,
		'member' => $_W['member'],
		'config_ordergrant' => $config_ordergrant,
		'grantType' => $grantType
	);
...
$_share = array(
	'title' => $config_ordergrant['ordergrant_share']['title'],
	'desc' => $config_ordergrant['ordergrant_share']['desc'],
	'link' => imurl('ordergrant/index', array(), true),
	'imgUrl' => tomedia($config_ordergrant['ordergrant_share']['imgUrl'])
);
