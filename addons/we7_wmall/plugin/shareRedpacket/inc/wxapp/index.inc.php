...
icheckauth();
$_W['_share'] = array(
	'title' => $redPacket['share']['title'],
	'desc' => $redPacket['share']['desc'],
	'link' => ivurl('/package/pages/shareRedpacket/invite', array('u' => $_W['member']['uid']), true),
	'imgUrl' => tomedia($redPacket['share']['imgUrl'])
);
if($op == 'invite') {
