define(['jquery.ui'], function(ui) {
	...
	diy.initParts = function(){
		...
		var partGroup = {
			...
			6: ['store_fixedsearch', 'store_searchbar', 'store_navs', 'store_notice', 'store_activity',  'store_waimai_goods', 'store_goodsTab', 'graphic', 'listmenu', 'cart', 'redpacket', 'guide', 'service', 'urltags', 'operation', 'info', 'tags', 'coupon', 'onsale', 'evaluate'],
			7: ['store_basic'],
		};
		...
		if(diy.checkPluginExist('hotGoods')) {
			partGroup[1].push('hot_goods');
		}
		...
		diy.parts = {
			...
			store_basic: {
				...
				style: {
					...
					buybtnbackground: '#ff2d4b',
					buybtncolor: '#ffffff',
					cartnumbackground: '#ffd400',
					cartnumcolor: '#3d4145',
					salescolor: '#777777',
				},
				data: {
					C0123456789101: {
						title: '天天特价',
						thumb: '../addons/we7_wmall/plugin/diypage/static/img/default/navs-1.png',
						num: 5,
						goods: {
							C0123456789101: {
								sid: '0',
					...
					C0123456789102: {
						title: '特色砂锅',
						thumb: '../addons/we7_wmall/plugin/diypage/static/img/default/navs-2.png',
						num: 0,
						goods: {}
					},
					C0123456789103: {
						title: '美味水饺',
						thumb: '../addons/we7_wmall/plugin/diypage/static/img/default/navs-3.png',
						num: 2,
						goods: {}
					},
					C0123456789104: {
						title: '经典小吃',
						thumb: '../addons/we7_wmall/plugin/diypage/static/img/default/navs-4.png',
						num: 0,
						goods: {}
					},
				},
			...
			hot_goods: {
				...
				style: {
					...
					searchlabelbackground: '#ffffff',
					searchlabelactivecolor: '#ffffff',
					searchlabelactivebackground: '#ff2d4b',
				},
				data: {
					C0123456789101: {
						sid: '0',
	...
	diy.callbackGoods = function(data) {
		...
		} else if(diy.items[itemid].id == 'store_goodsTab' && typeof(parentid) !== "undefined") {
			diy.items[itemid].data[parentid].goods[childid] = {
				sid: data.sid,
				goods_id: data.id,
				title: data.title,
	...
	diy.initSave = function() {
		$(".btn-save").unbind('click').click(function() {
			...
			irequire(['tiny'], function(tiny){
				...
				} else if(diy.type == 6 || diy.type == 7) {
					$.post(tiny.getUrl('store/decoration/diyPage/post'), {id: diy.id, data: diy.data}, function(ret) {
						var ret = ret.message;
						if(ret.errno != 0) {
							Notify.error(ret.message);
