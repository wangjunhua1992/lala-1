...
if($op == 'index') {
	...
	$array = array(
		...
		'scene' => "spread:{$_W['member']['uid']}",
		'path' => "/we7_wmall/wxappqrcode/spread/{$_W['uniacid']}/{$_W['member']['uid']}_spread.png"
	);
	...
	$params = array(
		...
		'member' => $_W['member'],
		'name' => "spread_wxapp_{$_W['member']['uid']}",
		'plugin' => 'spread',
		'extra' => $_W['member'],
	);
