...
if($op == 'create') {
	...
	$data = array(
		...
		'data' => array(
			...
			'version' => 'version_diy',
			'yinsihao_status' => intval($order['yinsihao_status']),
		),
		'delivery_fee' => $order['delivery_fee'],
		'delivery_tips' => floatval($order['delivery_tips']),
		'total_fee' => $order['total_fee'],
		'discount_fee' => $order['discount_fee'],
		'plateform_discount_fee' => $order['activityed']['plateform_discount_fee'],
		'agent_discount_fee' => $order['activityed']['agent_discount_fee'],
	...
	$data['plateform_serve'] = iserializer(array(
		'fee' => $data['plateform_serve_fee'],
		'note' => "订单配送费 {$_W['Lang']['dollarSign']}{$data['delivery_fee']} + 订单小费 {$_W['Lang']['dollarSign']}{$data['delivery_tips']} - 使用红包 {$_W['Lang']['dollarSign']}{$data['discount_fee']}"
	));
