define(['jquery.ui', 'clockpicker'], function(ui, $) {
	...
	diy.initPageColor = function() {
		$("#app-preview .shop-address .shop-address-type-item.active").css({'border-color': diy.page.activebackground});
		$("#app-preview .order-submit .order-info .num").css({color: diy.page.activebackground});
		$("#app-preview .order-submit .order-info .unit").css({color: diy.page.activebackground});
		$("#app-preview .shop-argeement .user-argeement .icon-check").css({color: diy.page.activecolor, background: diy.page.activebackground});
		$("#app-preview .order-submit .submit-btn").css({color: diy.page.activecolor, background: diy.page.activebackground});
	};
