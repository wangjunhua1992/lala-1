...
function errander_order_insert_status_log($id, $type, $note = '', $extra = array()) {
	...
	$notes = array(
		'place_order' => array(
			...
			'note' => "زاكاس نۇمۇرى:{$order['order_sn']}",
			'ext' => array(
				array(
					'key' => 'pay_time_limit',
					'title' => 'پۇل تۆلەۋاتىدۇ',
					'note' => "زاكاسنى يوللاپ{$config['pay_time_limit']}مىنۇت ئىچىدە پۇل تۆلەڭ",
				)
			)
		),
		'pay' => array(
			'status' => 2,
			'title' => 'زاكاسقا پۇل تۆلەندى',
			'note' => 'زاكاسقا پۇل تۆلەنگەن ۋاقىتى:' . date('Y-m-d H:i:s', $order['paytime']),
			'ext' => array(
				array(
					'key' => 'handle_time_limit',
					'title' => 'قوبۇللىنۋاتىدۇ',
					'note' => "زاكاسنى{$config['handle_time_limit']}مىنۇت ئىچىدە قوبۇللىمىسا，ئاپتۇماتىك قالدۇرلىدۇ",
				)
			)
		),
		...
		'delivery_transfer' => array(
			'status' => 7,
			'title' => 'يەتكۈزگۈچى زاكاسنى يۆتكىدى',
			'note' => ''
		),
		'direct_transfer' => array(
			'status' => 8,
			'title' => 'يەتكۈزگۈچى زاكاسنى باشقىلارغا يۆتكىدى',
			'note' => ''
		),
		'direct_transfer_agree' => array(
			'status' => 9,
			'title' => 'يەتكىۈزگۈچى زاكاسنى قوبۇللىدى',
			'note' => ''
		),
		'direct_transfer_refuse' => array(
			'status' => 10,
			'title' => 'يەتكۈزگۈچى زاكاسنى رەت قىلدى',
			'note' => ''
		),
