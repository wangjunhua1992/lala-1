define(['jquery.ui'], function(ui) {
	...
	diyMenu.init = function (params) {
		...
		diyMenu.type = params.type;
		if(!diyMenu.menu) {
			if(diyMenu.type == 'we7_wmall_deliveryer') {
				diyMenu.menu = {
					name: '自定义菜单',
					type: 0,
					params: {'navstyle': '0'},
					css: {
						...
						'color': '#929292',
						'selectedColor': '#4FAE52'
					},
					data: {
						M0123456789101: {
							pagePath: "pages/order/list",
							iconPath: "/static/img/tabbar/deliveryer/icon-1.png",
							selectedIconPath: "/static/img/tabbar/deliveryer/icon-1-active.png",
							text: '外卖'
						},
						M0123456789102: {
							pagePath: "pages/errander/list",
							iconPath: "/static/img/tabbar/deliveryer/icon-3.png",
							selectedIconPath: "/static/img/tabbar/deliveryer/icon-3-active.png",
							text: '跑腿'
						},
						M0123456789103: {
							pagePath: "pages/member/mine",
							iconPath: "/static/img/tabbar/deliveryer/icon-2.png",
							selectedIconPath: "/static/img/tabbar/deliveryer/icon-2-active.png",
							text: '我的'
						},
					}
				};
			} else if(diyMenu.type == 'we7_wmall_manager') {
				diyMenu.menu = {
					name: '自定义菜单',
					params: {'navstyle': '0'},
					css: {
						'backgroundColor': '#FFFFFF',
						'color': '#929292',
						'selectedColor': '#2F9AEA'
					},
					data: {
						M0123456789101: {
							pagePath: "pages/order/index",
							iconPath: "/static/img/tabbar/manager/icon-1.png",
							selectedIconPath: "/static/img/tabbar/manager/icon-1-active.png",
							text: '外卖'
						},
						M0123456789102: {
							pagePath: "pages/order/tangshi/index",
							iconPath: "/static/img/tabbar/manager/icon-2.png",
							selectedIconPath: "/static/img/tabbar/manager/icon-2-active.png",
							text: '店内'
						},
						M0123456789103: {
							pagePath: "pages/shop/home",
							iconPath: "/static/img/tabbar/manager/icon-3.png",
							selectedIconPath: "/static/img/tabbar/manager/icon-3-active.png",
							text: '运营'
						},
						M0123456789104: {
							pagePath: "pages/shop/setting",
							iconPath: "/static/img/tabbar/manager/icon-4.png",
							selectedIconPath: "/static/img/tabbar/manager/icon-4-active.png",
							text: '设置'
						}
					}
				};
	...
	diyMenu.save = function () {
		$(".btn-save").unbind('click').click(function() {
			...
			var posturl = "./index.php?c=site&a=entry&ctrl=wxapp&ac=menu&op=post&do=web&m=we7_wmall&type=" + diyMenu.type;
