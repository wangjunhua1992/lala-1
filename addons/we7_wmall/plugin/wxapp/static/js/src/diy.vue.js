define(['jquery.ui'], function(ui) {
	...
	diy.initParts = function(){
		diy.getParts();
		var partGroup = {
			0: ['picture', 'title', 'img_card', 'banner', 'picturew', 'listmenu', 'buttons', 'richtext', 'line', 'blank'],
			1: ['fixedsearch', 'searchbar', 'navs', 'notice', 'activity', 'danmu', 'selective', 'bargain',  'waimai_goods', 'waimai_stores', 'waimai_allstores', 'graphic', 'listmenu', 'cart', 'redpacket', 'guide', 'service', 'copyright'],
			2: ['memberHeader', 'memberBindMobile', 'blockNav', 'copyright'],
			3: ['searchbar', 'operation', 'info', 'tags', 'coupon', 'onsale', 'evaluate', 'redpacket'],
			4: ['fixedsearch', 'searchbar', 'navs', 'notice', 'activity', 'danmu', 'selective', 'bargain',  'waimai_goods', 'waimai_stores', 'graphic', 'listmenu', 'cart', 'guide', 'service', 'copyright']
		};
		...
		diy.parts = {
			...
			operation: {
				...
				params: {
					...
					showtype: 0,
					showdot: 0,
					has_diypage: diy.checkPluginExist('diypage')
				},
				style: {
					margintop: '0',
					style: 2,
