...
if($op == "afresh"){
	...
	$table = array(
		'tiny_wmall_goods', 'tiny_wmall_goods_category', 'tiny_wmall_store', 'tiny_wmall_store_account', 'tiny_wmall_store_category', 'tiny_wmall_lewaimai_log'
	);
