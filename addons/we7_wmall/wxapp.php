...
if($w == 'member') {
	...
	elseif(isset($_GPC['state']) && !empty($_GPC['state']) && strexists($_GPC['state'], 'we7sid-')) {
	...
	$dest_url = "{$dest_url}/addons/we7_wmall/template/vue/index.html?menu=aaa#/pages/home/index?i={$_W['uniacid']}";
