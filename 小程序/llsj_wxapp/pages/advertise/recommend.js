    ...
    onLoad: function() {
        ...
        e.util.request({
            ...
            success: function(t) {
                ...
                if (a.setData(d.message), a.data.advertise.recommendHome.leave > 0) for (var n in a.data.advertise.recommendHome.prices) {
                    a.data.day.recommendHome = n;
                    break;
                } else if (a.data.advertise.recommendOther.leave > 0) {
                    a.data.type = "recommendOther";
                    for (var n in a.data.advertise.recommendOther.prices) {
                        a.data.day.recommendOther = n;
                        break;
                    }
                }
                a.setData({
