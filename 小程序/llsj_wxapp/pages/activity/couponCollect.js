...
Page({
    ...
    onCoupon: function(a) {
        var e = this;
        return e.data.coupon = a.detail.value, !e.data.coupon.discount || e.data.coupon.discount < 0 ? (t.util.toast("请填写优惠金额", "", 1e3), 
        !1) : !e.data.coupon.condition || e.data.coupon.condition < 0 || e.data.coupon.condition < e.data.coupon.discount ? (t.util.toast("请填写使用条件", "", 1e3), 
        !1) : !e.data.coupon.use_days_limit || e.data.coupon.use_days_limit < 0 ? (t.util.toast("请填写有效期", "", 1e3), 
        !1) : (e.data.coupons.push(e.data.coupon), void e.setData({
