...
util.imessage = function(e, t, a) {
    ...
    var t = e.currentTarget.dataset, a = t.key, n = t.count || 9, i = util.getCurPage();
    util.image({
        count: n,
        success: function(e) {
            i.data[a].push(e);
    ...
    var e = util.getExtConfigSync();
    return e.siteInfo.version || (e.siteInfo.version = "未知"), e.siteInfo.version;
    ...
    util.request({
        ...
        success: function(t) {
            ...
            if ("wechat" == e.pay_type) return wx.requestPayment({
                ...
                paySign: t.paySign,
                success: function(t) {
                    return "function" == typeof e.success ? (e.success(t), !1) : n ? (util.toast("支付成功", n.url_detail, 3e3), 
                    !1) : void 0;
                },
                fail: function(t) {
            ...
            !1;
            return !!n && (util.toast("支付成功", n.url_detail, 3e3), !0);
        }
    });
    ...
    var n = wx.getStorageSync("msessionid");
    !getUrlParam(t, "state") && n ? t = t + "&state=we7sid-" + n : console.log("===商户小程序sessionid为空======");
    var i = wx.getStorageSync("__sid");
    if (!i && 1 != e.data.nosid) return wx.removeStorageSync("__sid"), void wx.redirectTo({
        url: "/pages/shop/select"
    });
    t = t + "&sid=" + i, wx.showNavigationBarLoading(), e.showLoading && util.showLoading(), 
    console.log(t), wx.request({
        ...
        success: function(t) {
            ...
            wx.setStorageSync("msessionid", t.data.global.sessionid), t.data.message.errno) {
    ...
    var t = wx.getStorageSync("clerkInfo"), a = wx.getStorageSync("__sid"), n = wx.getBackgroundAudioManager();
    n.title = "您有新的订单", t && t.token && a && setInterval(function() {
        util.request({
            url: "manage/common/orderNotice",
            success: function(e) {
                var t = e.data.message;
                t.errno ? n.stop() : n.src = t.message.audioSrc;
            }
        });
    }, 3e4);
    ...
    var e = wx.getStorageSync("clerkInfo");
    e.openid_wxapp_manager || e.token && wx.login({
        success: function(t) {
            util.request({
    ...
    if (!t) return !1;
    var n = [];
    Array.isArray(t) ? n = t : n.push(t), wx.previewImage({
        urls: n,
        current: a
    });
    ...
    return t;
}, util.setSid = function(e) {
    var t = util.getStorageSync("__sid");
    return e && e != t && util.setStorageSync("__sid", e), !0;
