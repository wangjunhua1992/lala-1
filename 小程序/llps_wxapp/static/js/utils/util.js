...
util.imessage = function(e, t, a) {
    ...
    1 != e.data.forceOauth || a && a.token) {
        var n = wx.getStorageSync("dsessionid");
        if (!getUrlParam(t, "state") && n ? t = t + "&state=we7sid-" + n : console.log("===配送员小程序sessionid为空======"), 
        !e.data.lat || !e.data.lng) {
            var i = util.getStorageSync("location");
            i && i.x && (e.data.lat = i.x, e.data.lng = i.y, e.data.__lat = i.x, e.data.__lng = i.y);
        }
        ...
        wx.request({
            ...
            success: function(t) {
                ...
                wx.setStorageSync("dsessionid", t.data.global.sessionid), t.data.message.errno && "41009" == t.data.message.errno) return wx.setStorageSync("deliveryerInfo", ""), 
